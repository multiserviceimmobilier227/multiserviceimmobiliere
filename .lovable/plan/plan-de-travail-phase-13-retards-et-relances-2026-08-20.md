...
Commence phase par phase de manière professionnelle et approfondie une fois une sous phases implémenter et finaliser tu t'arrêtes et tu le dis tout en préparant la prochaine sous phases pour implementation ainsi de suite ainsi de suite 